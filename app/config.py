...
class Config:
    ...
    def from_env(cls) -> "Config":
        # Vietnamese-language financial RSS feeds (default, since v2.1.0).
        # These are used whenever NEWS_SOURCES is unset OR explicitly empty.
        # Hardcoded as fallback so an out-of-date .env on the VPS cannot
        # silently downgrade the bot back to English sources.
        DEFAULT_VN_SOURCES = (
